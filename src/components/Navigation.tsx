...
const Navigation: React.FC = () => {
  ...
  const handleResumeUpload = (e: FileInputEvent): void => {
    if (e.target.files[0]) {
      setResumeFile(e.target.files[0]);
    }
  };
  
  const handleJobDescUpload = (e: FileInputEvent): void => {
    if (e.target.files[0]) {
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e: TextAreaChangeEvent) => setJobDescription(e.target.value)}
                        rows={4}
                        className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
